...
export const errorHandler = (err, req, res, next) => {
  ...
  } else if (err.name === "ConnectivityError") {
    // Connectivity error
    statusCode = 503;
    error.error = "Service Unavailable";
    error.message = err.message || "Unable to connect to external service";
...
export class ConnectivityError extends AppError {
  constructor(message = "Service connectivity failed") {
    super(message, 503, "ConnectivityError");
  }
}
